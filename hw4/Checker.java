...
public class Checker {
  ...
  private static List<Ast.Return> returnList = new ArrayList<Ast.Return>(); 
  //private static int returnStmtPos = 0;
  //private static boolean returnStmtCk = false;
  //private static 
  ...
  static void check(Ast.VarDecl n) throws Exception {
	...
	if (init)
		if (n.init != null && !(assignable(n.t, check(n.init))))
			ck = true;
	if (ck)
